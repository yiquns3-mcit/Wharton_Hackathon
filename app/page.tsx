    ...
    <nav className="bg-white border-b border-outline-variant sticky top-0 z-50"
      ...
      <div className="flex justify-between items-center w-full px-6 py-3 max-w-screen-2xl mx-auto">
        <div className="flex items-center gap-8">
          <span
            className="text-2xl font-black plusJakartaSans transition-opacity"
            style={{ color: '#0050b8', cursor: onLogoClick ? 'pointer' : 'default' }}
            onClick={onLogoClick}
            title={onLogoClick ? 'Back to hotel selection' : undefined}
          >
            Expedia
          </span>
...
export default function ReviewPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col inter" style={{ backgroundColor: '#fbf8ff', color: '#141936' }}>
      <NavBar onLogoClick={selectedId ? () => setSelectedId('') : undefined} />
